...
// The following class defines an instruction, represented in both undecoded binary form
// decoded to identify operation to do registers to act on any immediate operand value
